...
<div class="col-lg-7 mx-auto py-5">
    <?php if (session()->getFlashdata('update')) : ?>
        <div class="alert alert-success" role="alert">
            ...
            <p>Data ayah telah ter update</p>
        </div>
    <?php endif; ?>
    ...
    <form action="<?= $action; ?>" method="post" data-validate>
        ...
        <div class="d-md-flex justify-content-between">
            ...
            <div>
                ...
                <?php if (!empty($data_ayah)) : ?>
                    <a href="<?= base_url('ibu/create'); ?>" class="btn btn-info text-white"> Selanjutnya <i class="fas fa-arrow-right"></i></a>
                <?php endif; ?>
            </div>
